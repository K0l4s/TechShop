...
const AdminNavbar = () => {
  return (
    <div className="w-full bg-[#1E304B] h-16 flex justify-between items-center sticky top-0 text-white px-6 shadow-md">
      ...
      <div className="flex items-center gap-3 hover:bg-gray-600 cursor-pointer p-2 pr-4 rounded-full transition-all duration-300">
        <img src={default_avatar} alt="avatar" className="w-12 h-12 rounded-full border-2 border-white" />
