...
const EditCategoryPage: React.FC = () => {
    ...
    const handleCancel = () => {
        // Reset values when the user cancels
        setCategoryName('');
        setCategoryImage('https://via.placeholder.com/150'); // Default image
    };
        ...
        <div className="flex justify-center items-center min-h-screen bg-gray-100">
            <div className="p-6 w-full sm:w-1/3 md:w-1/2 bg-white rounded-lg shadow-lg">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    {/* Image File Input */}
                    <div className="mb-4">
                        <label htmlFor="categoryImage" className="block text-sm font-bold text-gray-600">Tải ảnh Danh mục</label>
