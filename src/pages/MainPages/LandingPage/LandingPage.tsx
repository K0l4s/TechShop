      ...
      <div className="flex flex-col items-center justify-center w-full p-10 mt-10">
        ...
        <div className="w-full gap-5 mt-5 grid grid-cols-4 md:grid-cols-2 sm:grid-cols-1 xl:grid-cols-4">
          {[1, 2, 3].map((item) => (
            ...
            >
              <img
                src="https://lh3.googleusercontent.com/6WlXymfP1jkLLluDyPKhHqR2rghguKzWxL1GmRGMHqZ3uXCDthdiUDDghyTgLaVraNe-PeZdny2s__vbfdL-pRd2_9PE7M6V=w1920-rw"
                alt="product"
                className="w-full h-40 object-cover rounded-lg"
              />
              <h1 className="text-xl font-bold mt-2">Product {item}</h1>
